            ...
            <tr class="information">
                <td colspan="2">
                    <table>
                        ...
                        <tr>
                            <td>
                            Invoice #: <?php echo $booking_number;?>
                            </td>
                            <td>
...
//$number_additional = $stmt_additional->fetchColumn(); 
            ...
            <tr class="detail">
                <td align="center">( <?php echo $booking_custname;?> )<br>ลายมือชื่อผู้พัก</td><td align="center">( <?php echo $addusername; ?> ) <br> เจ้าหน้าที่<br>วันที่พิมพ์ <?php echo datetime_sub_thai($dtnow); ?></td>
            </tr>
        </table>
    </div>
</body>
