...
if($act == 'add'){
	...
	$query = "INSERT INTO ".DB_PREFIX."area (area_number, changwat, ampur, tambon,village, zone_number, zone_name, details,area_color, zone_code,latitude,longitude) VALUES (?, ?,?, ?, ?, ?, ?, ?, ?,?,?,?)"; 
	...
	$stmt->bindParam(11, $latitude, PDO::PARAM_STR);
	$stmt->bindParam(12, $longitude, PDO::PARAM_STR);
