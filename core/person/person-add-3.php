...
$stmt = $conn->prepare("SELECT * FROM ".DB_PREFIX."person_sub WHERE cid = ?");
$stmt->execute([$cid]);
$row = $stmt->fetch(PDO::FETCH_ASSOC);

if ($row) {
  // The cid already exists in the database
...
if($level == "1"){
	...
	$stmt->bindParam(2, $org_id, PDO::PARAM_STR);
	$stmt->bindParam(3, $prename, PDO::PARAM_STR);
	$stmt->bindParam(4, $fname, PDO::PARAM_STR);
	$stmt->bindParam(5, $lname, PDO::PARAM_STR);
	$stmt->bindParam(6, $sex, PDO::PARAM_INT);
	$stmt->bindParam(7, $telephone, PDO::PARAM_STR);
	$stmt->bindParam(8, $house, PDO::PARAM_STR);
	$stmt->bindParam(9, $community, PDO::PARAM_STR);
	$stmt->bindParam(10, $road, PDO::PARAM_STR);
	$stmt->bindParam(11, $village, PDO::PARAM_STR);
	$stmt->bindParam(12, $tambon, PDO::PARAM_STR);
	$stmt->bindParam(13, $ampur, PDO::PARAM_STR);
	$stmt->bindParam(14, $changwat, PDO::PARAM_STR);
	$stmt->bindParam(15, $flag, PDO::PARAM_STR);
	$stmt->bindParam(16, $now, PDO::PARAM_STR);
	$stmt->bindParam(17, $logged_user_id, PDO::PARAM_STR);
	$stmt->bindParam(18, $cposition1, PDO::PARAM_STR);
	$stmt->bindParam(19, $cposition2, PDO::PARAM_STR);
	$stmt->bindParam(20, $cposition3, PDO::PARAM_STR);
