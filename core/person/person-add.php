...
$stmt->bindParam(20, $religion, PDO::PARAM_STR);
$stmt->bindParam(21, $occupation, PDO::PARAM_STR);
$stmt->bindParam(22, $education, PDO::PARAM_STR);
$stmt->bindParam(23, $abogroup, PDO::PARAM_STR);
$stmt->bindParam(24, $level, PDO::PARAM_STR);
$stmt->bindParam(25, $head, PDO::PARAM_STR);
$stmt->bindParam(26, $email, PDO::PARAM_STR);
$stmt->execute();
