...
$stmt = $conn->prepare("SELECT eq_id FROM ".DB_PREFIX."service_data WHERE s_oid = '$id' LIMIT 1  ");
$stmt->execute();
...
$query = "UPDATE ".DB_PREFIX."service_data SET flag = ? , edit_date = ? , edit_users = ? WHERE s_oid = ? LIMIT 1 "; 
