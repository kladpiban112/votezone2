...
if($action == "edit"){
 ...
 WHERE s.repair_id = '$repairid'  LIMIT 1";
...
?>
      ...
      <div class="ribbon-target bg-danger" style="top: 10px; right: -2px;"></div>
				<h3 class="card-title">
        <i class="fas fa-paste"></i>&nbsp;บันทึกใบเสนอราคา/อนุมัติงานซ่อม
				</h3>
				<div class="card-toolbar">
					<div class="example-tools justify-content-center">
						<a href="dashboard.php?module=<?php echo $module;?>&page=repair-quotation" class="btn btn-defalse btn-sm font-weight-bold mr-2" title="ย้อนกลับ"><i class="fa fa-chevron-left" title="ย้อนกลับ" ></i></a>
					</div>
				</div>
			</div>
...
<input type="hidden" class="form-control"  name="org_id" id="org_id" value="<?php echo $row_service['org_id'];?>"/>
  ...
  <div class="form-group row">
			...
			<div class="col-lg-6">
				...
				<input type="text" class="form-control"  name="fullname" id="fullname" placeholder="ชื่อผู้แจ้งซ่อม" value="<?php echo $row_person['fname']." ".$row_person['lname'];?>" disabled/>
    ...
    <!-- <div class="form-group row">
      ...
      <div class="col-lg-6">
        ...
        <span><i class="fas fa-paste"></i> ข้อมูลใบเสนอราคา/อนุมัติงานซ่อม <a href="#" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modalAddPayment"><i class="far fa-plus-square"></i> สร้างใบเสนอราคา</a></span>
        <hr>  
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel"><i class="far fa-plus-square"></i> สร้างใบเสนอราคา</h5>
                                    ...
                                    <form class="form" enctype="multipart/form-data" autocomplete="off">
                                        ...
                                        <input type="hidden" class="form-control"  name="org_id" id="org_id" value="<?php echo $logged_org_id;?>"/>
                                          ...
                                          <input type="text" class="form-control"  name="qtdate" id="qtdate" data-date-language="th-th" maxlength="10"  placeholder="" value="<?php echo date("d/m/").(date("Y")+543)?>"/>
                                        </div>

                                            <div class="col-lg-2">
                                              <label>จำนวนวันใบเสนอราคา</label>
                                              <input type="number" class="form-control"  name="qtdayexp" id="qtdayexp" placeholder="" value="30"/>
                                            </div>

                                          
                                            <div class="col-lg-2">
                                              <label>จำนวนเงิน(บาท)</label>
                                              <input type="number" class="form-control"  name="qtprice" id="qtprice" placeholder="" value=""/>
                                            </div>

                                            <div class="col-lg-2">
                                              <label>%VAT</label>
                                              <input type="number" class="form-control"  name="qtvat" id="qtvat" placeholder="" value="7"/>
                                            </div>
                                          ...
                                          <div class="form-group row">
                                            <div class="col-lg-12">
                                              ...
                                              <textarea class="form-control"  name="qtnote" id="qtnote"></textarea>
                                            </div>
                                            </div>
                                          ...
                                          <div class="form-group row">
                                            <div class="col-lg-2">
                                            <button type="button" class="btn btn-success mr-2" id="btnAddQuotation"><i class="far fa-save"></i> บันทึก</button>
                                            </div>
...
function loaddata_quotation_data() {
            var repairid = $("#repairid").val();
            var personid = $("#personid").val();
                $.ajax({
                    type: "POST",
                    url: "views/finance/repair-quotation-data.php",
                    //dataType: "json",
...
$('#btnAddQuotation').click(function(e){
        ...
        }else if ($('#qtdate').val().length == ""){
                Swal.fire({
                    icon: 'error',
                    title: 'กรุณาระบุวันที่เสนอราคา',
                    showConfirmButton: false,
                    timer: 1000
                    });
        ...
        }else if ($('#qtusers').val().length == ""){
                Swal.fire({
                    icon: 'error',
                    title: 'กรุณาระบุผู้เสนอราคา',
                    showConfirmButton: false,
                    timer: 1000
                    });
        }else {
        ...
        $.ajax({
            type: "POST",
            url: "core/finance/repair-quotation-add.php",
            dataType: "json",
			data: data,
			processData: false,
            contentType: false,
