...
if($action == "view"){
	...
	$stmt_data = $conn->prepare ("SELECT p.*,o.org_name,pr.prename FROM ".DB_PREFIX."donor_main p 
    ...
    $sql_service = "SELECT s.*,t.service_title AS service_typename FROM ".DB_PREFIX."donate_main s 
        ...
        <div class="row justify-content-center py-8 px-8 py-md-27 px-md-0">
            <div class="col-md-9">
                <div class="d-flex justify-content-between pb-10 pb-md-20 flex-column flex-md-row">
                    <h4 class=" mb-10">เอกสารรับบริจาคกายอุปกรณ์</h4>
                ...
                <div class="d-flex justify-content-between pt-6">
                    <div class="d-flex flex-column flex-root">
                        <span class="font-weight-bolder mb-2">ผู้บริจาคกายอุปกรณ์</span>
                        ...
                        <span class="opacity-70">ที่อยู่ : <?php  echo getDonorAddr($personid);?></span>
                    </div>
               
                    <div class="d-flex flex-column flex-root">
                        <span class="font-weight-bolder mb-2">วันที่บริจาค</span>
    ...
    <?php
            ...
            while ($row = $stmt_data->fetch(PDO::FETCH_ASSOC))
            {
                ...
                <tr>
                            ...
                            <td class="text-center" width="100px"><div class="symbol symbol-50 symbol-lg-60">
                            <?php if($eq_img == ""){?>
                            ...
                            <td width="130px"><?php echo $eq_code;?></td>
