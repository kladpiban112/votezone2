...
$stmt_data = $conn->prepare ("SELECT u.*,e.*,t.eq_typename,s.status_title
...
LEFT JOIN ".DB_PREFIX."equipment_status s ON e.flag = s.status_id
                            ...
                            <td class="text-center">
                                 ...
                                 <div class="dropdown">
                                    ...
                                    <ul class="navi navi-hover py-1">
                                        ...
                                        <li class="navi-item">
                                            <a href="#" class="navi-link" onclick='delDonate(<?php echo $s_oid; ?>)'>
