                            ...
                            <div class="col-xl-2">
                                    <div class="card card-custom gutter-b" style="height: 150px">
                                        <div class="card-body">
                                            ...
                                            <a href="#" class="text-muted text-hover-primary font-weight-bold font-size-lg mt-1">ซ่อมวันนี้</a>
                                        </div>
                                    </div>
                            </div>
                            ...
                            <div class="col-xl-2">
                                    <div class="card card-custom gutter-b" style="height: 150px">
                                        <div class="card-body">
                                            ...
                                            <a href="#" class="text-muted text-hover-primary font-weight-bold font-size-lg mt-1">ซ่อมทั้งหมด</a>
                                        </div>
                                    </div>
                            </div>
                            ...
                            <div class="col-xl-2">
                                    <div class="card card-custom gutter-b" style="height: 150px">
                                        <div class="card-body">
                                            ...
                                            <div class="text-dark font-weight-bolder font-size-h2 mt-3"><?php //echo $numb_service_today;?></div>
                                            <a href="#" class="text-muted text-hover-primary font-weight-bold font-size-lg mt-1">กำลังซ่อม</a>
                                        </div>
                                    </div>
                            </div>
                            ...
                            <div class="col-xl-2">
                                    <div class="card card-custom gutter-b" style="height: 150px">
                                        <div class="card-body">
                                            ...
                                            <div class="text-dark font-weight-bolder font-size-h2 mt-3"><?php //echo $numb_service_today;?></div>
                                            <a href="#" class="text-muted text-hover-primary font-weight-bold font-size-lg mt-1">ซ่อมเสร็จ</a>
                                        </div>
                                    </div>
                            </div>
                            ...
                            <div class="col-xl-2">
                                    <div class="card card-custom gutter-b" style="height: 150px">
                                        <div class="card-body">
                                            ...
                                            <div class="text-dark font-weight-bolder font-size-h2 mt-3"><?php //echo $numb_service_today;?></div>
                                            <a href="#" class="text-muted text-hover-primary font-weight-bold font-size-lg mt-1">ซ่อมภายนอก</a>
                                        </div>
                                    </div>
                            </div>
                            ...
                            <div class="col-xl-2">
                                    <div class="card card-custom gutter-b" style="height: 150px">
                                        <div class="card-body">
                                            ...
                                            <div class="text-dark font-weight-bolder font-size-h2 mt-3"><?php //echo $numb_service_today;?></div>
                                            <a href="#" class="text-muted text-hover-primary font-weight-bold font-size-lg mt-1">รอรับคืน</a>
                                        </div>
                                    </div>
                            </div>
