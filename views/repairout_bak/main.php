...
?>
		...
		<div class="card card-custom gutter-b example example-compact">
			<div class="card-header">
				<h3 class="card-title">
                <i class="fas fa-sign-out-alt"></i>&nbsp;ข้อมูลการส่งซ่อมภายนอก
				</h3>
    ...
    <?php
       if($logged_user_role_id == '1'){
        $conditions = " AND u.repair_out = 'O' ";
        }else{

        $conditions = " AND u.org_id = '$logged_org_id'  AND u.repair_out = '1'  ";
        }
    ...
    <tbody>
            ...
            while ($row = $stmt_data->fetch(PDO::FETCH_ASSOC))
            {
                ...
                <tr>
                            ...
                            <td class="text-center"><?php echo $repair_outcode;?></td>
                            <td><?php echo $repair_outdate;?></td>
