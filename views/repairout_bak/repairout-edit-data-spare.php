...
<div class="card card-custom gutter-b example example-compact">
    <div class="card-header ribbon ribbon-right">
        ...
        <h3 class="card-title">
            <i class="fas fa-edit"></i>&nbsp;<?php echo $txt_title; ?>อะไหล่ใช้งาน
        </h3>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-2">
                            ...
                            <select class="form-control " name="spare_unit" id="spare_unit">
                                ...
                                <option value="<?php echo $id_selected; ?>" <?php if ($id_selected == $spare_unit) {
                                                                    echo 'selected';
...
$('#btnEditSpare').click(function(e) {
    ...
    if ($('#repairid').val().length == "") {
        ...
        $.ajax({
            type: "POST",
            url: "core/repairout/repairout-edit-data-spare.php",
            dataType: "json",
            data: data,
            processData: false,
            contentType: false,
