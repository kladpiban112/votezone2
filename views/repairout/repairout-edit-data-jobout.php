...
if ($action == 'edit') {
    ...
    $stmt_data = $conn->prepare('SELECT u.* FROM '.DB_PREFIX."repair_jobout u 
...
<div class="card card-custom gutter-b example example-compact">
    <div class="card-header ribbon ribbon-right">
        ...
        <h3 class="card-title">
            <i class="fas fa-edit"></i>&nbsp;<?php echo $txt_title; ?>เลขที่ส่งซ่อมภายนอก
        </h3>
    ...
    <form class="form" enctype="multipart/form-data">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <textarea class="form-control editor" name="job_desc"
                                id="job_desc"><?php echo $job_desc; ?></textarea>
                        </div>
                    </div>
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col-lg-6">
                    <button type="button" class="btn btn-primary mr-2" id="btnEditjobout"><i class="fa fa-save"
...
$('#btnEditjobout').click(function(e) {
    e.preventDefault();
    if ($('#repairid').val().length == "") {
        ...
        $.ajax({
            type: "POST",
            url: "core/repairout/repairout-edit-data-jobout.php",
            dataType: "json",
            data: data,
            processData: false,
            contentType: false,
