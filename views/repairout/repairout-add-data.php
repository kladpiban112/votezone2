...
if ($action == 'edit') {
  ...
  WHERE p.oid = '$personid'  LIMIT 1");
    ...
    $sql_service = "SELECT s.*,r.repair_code AS repair_refcode FROM ".DB_PREFIX."repair_main s 
	LEFT JOIN ".DB_PREFIX."person_main p ON s.person_id = p.oid 
    LEFT JOIN ".DB_PREFIX."repair_main r ON s.repair_refid = r.repair_id
    WHERE s.repair_id = '$repairid' AND s.flag != '0'  LIMIT 1";
    $stmt_service = $conn->prepare($sql_service);
    $stmt_service->execute();
    $row_service = $stmt_service->fetch(PDO::FETCH_ASSOC);
    $repair_refcode = $row_service['repair_refcode'];
...
<div class="card card-custom gutter-b example example-compact">
    <div class="card-header ribbon ribbon-right">
        ...
        <h3 class="card-title">
            <i class="fas fa-list"></i>&nbsp;<?php echo $txt_title; ?>รายละเอียดการส่งซ่อมภายนอก เลขที่ส่งซ่อมภายนอก :  <?php echo $row_service['repair_code']; ?>
        </h3>
    ...
    <div class="alert-text">รออนุมัติการซ่อม</div>
    <div class="alert-close">
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true"><i class="ki ki-close"></i></span>
                    ...
                    <span><i class="far fa-bookmark"></i> ข้อมูลส่งซ่อม</span>
                    <hr>
                    <div class="form-group row">
                    ...
                    ?>
                        ...
                        <div class="col-lg-4">
                            <label>อ้างอิง:เลขที่แจ้งซ่อม</label>
                            <input type="text" class="form-control" name="repair_refid" id="repair_refid" placeholder=""
                                value="<?php echo $repair_refcode; ?>" disabled />
                            <span class="form-text text-muted"></span>
				...
				<select class="form-control " name="org_id" id="org_id" disabled>
                    ...
                    <!-- <div class="form-group row">
                        ...
                        <div class="col-lg-3">
                            ...
                            <input type="text" class="form-control" name="repairoutdate" id="repairoutdate"
                                placeholder="วันที่ส่งซ่อมภายนอก"
                                value="<?php echo date_db_2form($row_service['repair_outdate']); ?>"
                        ...
                        <div class="col-lg-3">
                            ...
                            <input type="text" class="form-control" name="repair_outcode" id="repair_outcode"
                                placeholder="" value="<?php echo $row_service['repair_outcode']; ?>" disabled />
                            <span class="form-text text-muted"></span>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <input type="text" class="form-control" placeholder="" name="repair_placeto"
                                id="repair_placeto" value="<?php echo $row_service['repair_placeto']; ?>" />
                        </div>
                    </div>
                ...
                <div class="col-lg-5 border-x-0 border-x-md border-y border-y-md-0">
                    ...
                    <div class="form-group row">
                        <!-- <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" name="approvedate" id="approvedate"
                                placeholder="วันที่อนุมัติซ่อม"
                                value="<?php echo date_db_2form($row_service['approve_date']); ?>"
                                data-date-language="th-th" maxlength="10" />
                        </div>
                        <div class="col-lg-8">
                            <label>ผู้อนุมัติซ่อม</label>
                            <input type="text" class="form-control" name="approve_username" id="approve_username"
                                placeholder="" value="<?php echo $row_service['approve_username']; ?>" />
                        </div> -->
                    ...
                    <span><i class="fas fa-dollar-sign"></i> ค่าซ่อม <!--<a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target="#modalAddCost"><i class="far fa-plus-square"></i> บันทึกค่าซ่อม</a>--></span>
        <hr>  
        ...
        <span><i class="fas fa-pen-square text-warning"></i> บันทึกรายละเอียดการซ่อม </span>
                    ...
                    <span><i class="fas fa-cog"></i> อะไหล่ภายนอก <a href="#" class="btn btn-sm btn-success"
                            data-toggle="modal" data-target="#modalAddSpare"><i class="far fa-plus-square"></i>
                            บันทึกอะไหล่</a></span>
                    <hr>
                    <div id="spare_detail"></div>

                    <span><i class="fas fa-list"></i> สถานะการซ่อมภายนอก <a href="#" class="btn btn-sm btn-success"
                    ...
                    <span><i class="fas fa-truck"></i> การขนส่ง <a href="#" class="btn btn-sm btn-success"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <input type="hidden" class="form-control" name="status_out" id="status_out" value="O" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <label>อะไหล่</label>
                            <input type="text" class="form-control" name="spare_id" id="spare_id" placeholder=""
                                value="" />
                        ...
                        <div class="col-lg-2">
                            ...
                            <select class="form-control " name="spare_unit" id="spare_unit">
                                ...
                                <?php
                                                            ...
                                                            $stmt_user_role = $conn->prepare('SELECT * FROM '.DB_PREFIX.'cunit ORDER BY unit_id ASC');
                                                            $stmt_user_role->execute();
                                                            while ($row = $stmt_user_role->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                                <div class="modal-content">
                                    ...
                                    <input type="hidden" class="form-control"  name="repairid" id="repairid" value="<?php echo $repairid;?>"/>
                                      ...
                                      <div class="form-group row">
                                        <div class="col-lg-2">
                                        <button type="button" class="btn btn-success mr-2" id="btnAddCost"><i class="far fa-save"></i> บันทึก</button>
                                        </div>
...
function loaddata_spare_data() {
    ...
    $.ajax({
        type: "POST",
        url: "views/repairout/repairout-add-data-spare.php",
        //dataType: "json",
        data: {
            repairid: repairid,
            personid: personid
...
function loaddata_status_data() {
    ...
    $.ajax({
        type: "POST",
        url: "views/repairout/repairout-add-data-status.php",
        //dataType: "json",
        data: {
            repairid: repairid,
            personid: personid
...
function loaddata_cost_data() {
            ...
            var personid = $("#personid").val();
                $.ajax({
                    type: "POST",
                    url: "views/repairout/repairout-add-data-cost.php",
                    //dataType: "json",
...
$('#btnSave').click(function(e) {
    ...
    if ($('#repair_type').val().length == "") {
        ...
        $.ajax({
            type: "POST",
            url: "core/repairout/repairout-add-data.php",
            dataType: "json",
            data: data,
            processData: false,
            contentType: false,
...
$('#btnAddSpare').click(function(e) {
    ...
    if ($('#repairid').val().length == "") {
        ...
        $.ajax({
            type: "POST",
            url: "core/repairout/repairout-add-data-spare.php",
            dataType: "json",
            data: data,
            processData: false,
            contentType: false,
...
function delSpareData(id) {
    Swal.fire({
        ...
        if (result.value) { //Yes
            $.post("core/repairout/repairout-del-data-spare.php", {
                id: id
            }, function(result) {
                loaddata_spare_data();
            });
...
$('#btnAddStatus').click(function(e) {
    ...
    if ($('#repairid').val().length == "") {
        ...
        $.ajax({
            type: "POST",
            url: "core/repairout/repairout-add-data-status.php",
            dataType: "json",
            data: data,
            processData: false,
            contentType: false,
...
$('#btnAddCost').click(function(e){
        ...
        $.ajax({
            type: "POST",
            url: "core/repairout/repairout-add-data-cost.php",
            dataType: "json",
			data: data,
			processData: false,
            contentType: false,
...
function delStatusData(id) {
    Swal.fire({
        ...
        if (result.value) { //Yes
            $.post("core/repairout/repairout-del-data-status.php", {
                id: id
            }, function(result) {
                loaddata_status_data();
            });
...
function delLogisticData(id) {
    Swal.fire({
        ...
        if (result.value) { //Yes
            $.post("core/repairout/repairout-del-data-logistic.php", {
                id: id
            }, function(result) {
                loaddata_logistic_data();
            });
