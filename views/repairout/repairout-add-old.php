...
<div class="card card-custom gutter-b example example-compact">
            ...
            <div class="row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" name="repair_code" id="repair_code" placeholder=""
                                value="<?php echo $row_service['repair_code']; ?>" />
              ...
              ?>
                ...
                <div class="col-lg-5 border-x-0 border-x-md border-y border-y-md-0">
                    ...
                    <span><i class="fas fa-dollar-sign"></i> ค่าซ่อม <a href="#" class="btn btn-sm btn-success"
                            data-toggle="modal" data-target="#modalAddCost"><i class="far fa-plus-square"></i>
                            บันทึกค่าซ่อม</a></span>
                    <hr>
  ...
  ?>
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col-lg-6">
                    <button type="button" class="btn btn-primary mr-2" id="btnAdd"><i class="fa fa-save"
