...
<div class="card card-custom gutter-b example example-compact">
    <div class="card-header">
        <h3 class="card-title">
            <i class="fas fa-cart-arrow-down"></i>&nbsp;<?php echo $txt_title; ?>รับเข้าอะไหล่
        </h3>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <?php if ($action == 'edit') {?>
                    <span><i class="fas fa-plus-circle"></i> เลือกอะไหล่</span>
                    <hr>
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label>อะไหล่</label>
                      ...
                      WHERE s.spare_type = 1 and s.flag = 1  $conditions  ORDER BY s.spare_id ASC");
                      $stmt_user_role->execute();
                      while ($row = $stmt_user_role->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    <div class="form-group row">
                        <div class="col-lg-2">
                            <button type="button" class="btn btn-success mr-2" id="btnAddSpare"><i
                                    class="fas fa-plus-circle"></i> เพิ่มอะไหล่</button>
                        </div>

                    </div>
                    <span><i class="fas fa-list"></i> รายการอะไหล่</span>
                    <hr>
                    <div class="form-group row">
                        <div class="col-lg-12">
...
function loaddata_receive_data() {
    ...
    $.ajax({
        type: "POST",
        url: "views/spare/spare-receive-data.php",
        //dataType: "json",
        data: {
            receiveid: receiveid
        },
                        ...
                        .then((value) => {
                            ...
                            if (data.act == '') {
                                window.location.replace(
                                    "dashboard.php?module=spare&page=spare-receive-list");
                            } else {
                                window.location.replace(
                                    "dashboard.php?module=spare&page=spare-receive&id=" +
