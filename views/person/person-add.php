                    ...
                    <div class="form-group row">
                        <div class="col-lg-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control form-control-sm" placeholder="ชื่อ-สกุล"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-2">
                            ...
                            <select class="form-control form-control-sm" name="religion" id="religion">
                                <option value="" <?php if($row_person['religion'] == "" ){echo "selected";} ?>>ระบุ
                                </option>
                                <?php
                          ...
                          while ($row = $stmt_user_role->fetch(PDO::FETCH_ASSOC))
                            ...
                            ?>
                                <option value="<?php echo $id_selected;?>"
                                    <?php if($row_person['religion'] == $id_selected ){echo "selected";} ?>>
                                    <?php echo $title_selected;?></option>
                                <?php
                            }
                          ?>
                        ...
                        <div class="col-lg-3">
                            ...
                            <select class="form-control form-control-sm" name="occupation" id="occupation">
                                <option value="" <?php if($row_person['occupation'] == "" ){echo "selected";} ?>>
                                    ระบุ
                                </option>
                                <?php
                          ...
                          while ($row = $stmt_user_role->fetch(PDO::FETCH_ASSOC))
                            ...
                            ?>
                                <option value="<?php echo $id_selected;?>"
                                    <?php if($row_person['occupation'] == $id_selected ){echo "selected";} ?>>
                                    <?php echo $title_selected;?></option>
                                <?php
                            }
                          ?>
                        ...
                        <div class="col-lg-3">
                            ...
                            <select class="form-control form-control-sm" name="education" id="education">
                                <option value="" <?php if($row_person['education'] == "" ){echo "selected";} ?>>ระบุ
                                </option>
                                <?php
                          ...
                          while ($row = $stmt_user_role->fetch(PDO::FETCH_ASSOC))
                            ...
                            ?>
                                <option value="<?php echo $id_selected;?>"
                                    <?php if($row_person['education'] == $id_selected ){echo "selected";} ?>>
                                    <?php echo $title_selected;?></option>
                                <?php
                            }
                          ?>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-2">
                            ...
                            <select class="form-control form-control-sm" name="abogroup" id="abogroup">
                                <option value="" <?php if($row_person['abogroup'] == "" ){echo "selected";} ?>>ระบุ
                                </option>
                                <?php
                          ...
                          while ($row = $stmt_user_role->fetch(PDO::FETCH_ASSOC))
                            ...
                            ?>
                                <option value="<?php echo $id_selected;?>"
                                    <?php if($row_person['abogroup'] == $id_selected ){echo "selected";} ?>>
                                    <?php echo $title_selected;?></option>
                                <?php
                            }
                          ?>
                        ...
                        .then((value) => {
                            if (data.method == "add") {
                                window.location.replace(
                                    "dashboard.php?module=person&page=person-add&personid=" +
