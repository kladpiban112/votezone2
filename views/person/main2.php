...
<div class="card card-custom gutter-b example example-compact">
    ...
    $numb_data = $conn->query("SELECT count(1) FROM ".DB_PREFIX."person_main p  WHERE p.flag != '0' $conditions  $search_data    $cid_data  $slevel_data $cchangwat_data $campur_data $ctambon_data $cposition1_data ")->fetchColumn();
