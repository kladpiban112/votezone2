...
<div class="card card-custom gutter-b example example-compact">
    <div class="card-header">
        <h3 class="card-title">
            <i class="fas fa-shopping-basket"></i>&nbsp;รายการรับเข้าคลังเครื่องมือ
        </h3>
        <div class="card-toolbar">
            <div class="example-tools justify-content-center">
                <a href="dashboard.php?module=tools&page=tools-receive"
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                                    ...
                                    <ul class="navi navi-hover py-1">
                                        <li class="navi-item">
                                            <a href="dashboard.php?module=tools&page=tools-receive-print&id=<?php echo $receiveid; ?>&act=<?php echo base64_encode('view'); ?>"
                                                class="navi-link">
                                        ...
                                        <li class="navi-item">
                                            <a href="dashboard.php?module=tools&page=tools-receive&id=<?php echo $receiveid; ?>&act=<?php echo base64_encode('edit'); ?>"
                                                class="navi-link">
