...
<div class="card card-custom gutter-b example example-compact">
    <div class="card-header">
        <h3 class="card-title">
            <i class="fas fa-cogs"></i>&nbsp;คลังเครื่องมือ
        </h3>
        <div class="card-toolbar">
            <div class="example-tools justify-content-center">
                <a href="dashboard.php?module=tools&page=tools-add" class="btn btn-success btn-sm font-weight-bold mr-2"
    ...
    <div class="card-body">
        ...
        <form class="form" enctype="multipart/form-data" method="GET">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-3">
                    <label>รหัส/ชื่อ/เครื่องมือ</label>
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="เครื่องมือ" name="search" id="search"
    ...
    $numb_data = $conn->query('SELECT count(1) FROM '.DB_PREFIX."spare_main u  WHERE u.spare_type = '2' and u.flag IS NOT NULL  $conditions  $search_data ")->fetchColumn();
        ...
        WHERE u.spare_type = '2' and u.flag IS NOT NULL   $conditions $search_data
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                                    ...
                                    <ul class="navi navi-hover py-1">
                                        <li class="navi-item">
                                            <a href="dashboard.php?module=tools&page=tools-add&id=<?php echo $spareid; ?>&act=<?php echo base64_encode('edit'); ?>"
                                                class="navi-link">
