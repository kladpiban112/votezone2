...
if ($action == 'view') {
    ...
    $stmt_data = $conn->prepare('SELECT u.*,o.org_name,o.org_shortname,t.eq_typename,s.status_title,s.status_color,r.rec_title 
            ...
            <div class="row justify-content-center py-8 px-8 py-md-27 px-md-0">
                <div class="col-md-9">
                    ...
                    <div class="d-flex justify-content-between pt-6">
                        ...
                        <div class="d-flex flex-column flex-root">
                            <span class="font-weight-bolder mb-2"><img src="uploads/qrcode/<?php echo $id; ?>.png"
                                    alt="image" /></span>
                    ...
                    <div class="row justify-content-center py-8 px-8 py-md-0 px-md-0">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="symbol symbol-150 mr-3">
                                <img src="uploads/equipment/<?php echo $file_name; ?>" alt="image"
