...
<div class="card card-custom gutter-b example example-compact">
    <div class="card-header">
        <h3 class="card-title">
            <i class="fas fa-cogs"></i>&nbsp;<?php echo $txt_title; ?>เครื่องมือ
        </h3>
    ...
    <form class="form" enctype="multipart/form-data">
                ...
                <div class="col-lg-9">
                    <div class="form-group row">
                        <div class="col-lg-8">
                            ...
                            <input type="text" class="form-control" name="spare_name" id="spare_name" placeholder=""
                                value="<?php echo $row_data['spare_name']; ?>" />
                        </div>
                        <div class="col-lg-4">
                            <label>รหัสเครื่องมือ</label>
                            <input type="text" class="form-control" name="spare_code" id="spare_code" placeholder=""
                                value="<?php echo $row_data['spare_code']; ?>" />
                        </div>
                    ...
                    $stmt_user_role = $conn->prepare('SELECT * FROM '.DB_PREFIX.'cspare_type where spare_typeid = 2');
                    ...
                    while ($row = $stmt_user_role->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        $title_selected = stripslashes($row['spare_title']); ?>
                                <option value="<?php echo $id_selected; ?>" <?php if ($row_data['spare_type'] == $id_selected) {
                            echo 'selected';
                    ...
                    while ($row = $stmt_user_role->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        $title_selected = stripslashes($row['unit_title']); ?>
                                <option value="<?php echo $id_selected; ?>" <?php if ($row_data['spare_unit_master'] == $id_selected) {
                            echo 'selected';
                        } ?>><?php echo $title_selected; ?></option>
                                <?php
                    }
                    ...
                    while ($row = $stmt_user_role->fetch(PDO::FETCH_ASSOC)) {
                        $id_selected = $row['unit_id'];
                        $title_selected = stripslashes($row['unit_title']); ?>
                                <option value="<?php echo $id_selected; ?>" <?php if ($row_data['spare_unit_slave'] == $id_selected) {
                            echo 'selected';
                        } ?>><?php echo $title_selected; ?></option>
                                <?php
                    }
                    ?>
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" name="spare_unit_cal" id="spare_unit_cal"
                                placeholder="" value="<?php echo $row_data['spare_unit_cal']; ?>" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-4">
                            <label>คงเหลือ(หน่วยรอง)</label>
                            <input type="text" class="form-control" name="spare_stock" id="spare_stock" placeholder=""
                                value="<?php echo $row_data['spare_stock']; ?>" />
                        </div>
                        <div class="col-lg-5">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <textarea rows="" class="form-control editor" name="spare_desc"
                                id="spare_desc"><?php echo $row_data['spare_desc']; ?></textarea>
                        </div>
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col-lg-6">
                    <button type="button" class="btn btn-primary mr-2" id="btnSaveUsers"><i class="fa fa-save"
            ...
            success: function(data) {
                if (data.code == "200") {
                    Swal.fire({
                        ...
                        .then((value) => {
                            //liff.closeWindow();
                            window.location.replace("dashboard.php?module=tools");
                        });
