...
?>
      ...
      <div class="ribbon-target bg-danger" style="top: 10px; right: -2px;">+</div>
				<h3 class="card-title">
        <i class="fas fa-user-cog"></i>&nbsp;<?php //echo $txt_title;?>แจ้งซ่อม 
				</h3>
...
<input type="hidden" class="form-control"  name="org_id" id="org_id" value="1"/>
	<div class="card-body">
  ...
  <hr>   
    ...
    <div class="col-lg-2">
				...
				<input type="text" class="form-control"  name="repairdate" id="repairdate" placeholder="วันที่แจ้งซ่อม" value="<?php echo date_db_2form(date("Y-m-d"));?>"  data-date-language="th-th" maxlength="10" />
...
$('#btnSave').click(function(e){
        ...
        $.ajax({
            type: "POST",
            url: "core/public/repair-add.php",
            dataType: "json",
			data: data,
			processData: false,
            contentType: false,
            success: function(data) {  
              if (data.code == "200") {
                ...
                timer: 1500
                    ...
                    //window.location.replace("dashboard.php?module=public&page=repair-add-data&personid="+data.personid+"&repairid="+data.repairid+"&act="+data.act);
