...
if ($action == 'edit') {
    ...
    $sql = 'SELECT u.*,s.spare_name sparename,s.spare_code,t.unit_title
                        ...
                        <div class="col-lg-6">
                            ...
                            <select class="form-control " name="spare_id" id="spare_id">
                                ...
                                <?php
                                                            ...
                                                            ?>
                                <option value="0" <?php if ($spare_id == '0') {
                                                                echo 'selected';
                                                            } ?>>อื่น ๆ</option>
                            </select>
                        </div>
                    ...
                    <div class="form-group row" id="spare_oth">
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" name="spare_other" id="spare_other"
                                placeholder="ระบุอะไหล่อื่น ๆ" value="<?php echo $spare_other; ?>" />
                        </div>
                    </div>
...
$('#btnEditSpare').click(function(e) {
    ...
    if ($('#repairid').val().length == "") {
        ...
        $.ajax({
            type: "POST",
            url: "core/repair/repair-edit-data-spare.php",
            dataType: "json",
            data: data,
            processData: false,
            contentType: false,
