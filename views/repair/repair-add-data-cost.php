                            ...
                            <!-- <td class="text-center">
                                 ...
                                 <div class="dropdown">
                                    ...
                                    <ul class="navi navi-hover py-1">
                                        ...
                                        <li class="navi-item">
                                            <a href="dashboard.php?module=repair&page=repair-edit-data-cost&repairid=<?php echo $repairid_enc;?>&personid=<?php echo $personid_enc;?>&costid=<?php echo $oid_enc;?>&act=<?php echo base64_encode('edit');?>" class="navi-link"  >
