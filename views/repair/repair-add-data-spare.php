...
$sql = 'SELECT u.*,s.spare_name,s.spare_code,t.unit_title
    ...
    if ($numb_rows > 0) {
                        ...
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                            ...
                            <ul class="navi navi-hover py-1">
                                ...
                                <li class="navi-item">
                                    ...
                                    <a href="dashboard.php?module=repair&page=repair-edit-data-spare&repairid=<?php echo $repairid_enc; ?>&personid=<?php echo $personid_enc; ?>&spareid=<?php echo $oid_enc; ?>&act=<?php echo base64_encode('edit'); ?>"
                                        class="navi-link">
                                        <span class="navi-icon"><i class="fas fa-edit"></i></span>
                                        <span class="navi-text">แก้ไข</span>
                                    </a>
        ...
        <tfooter>
            <tr>
                ...
                <td><?php echo number_format($sum_spare_price, 2); ?></td>
                <td></td>
