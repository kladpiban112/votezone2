...
?>
			...
			<div class="card-header">
				...
				<div class="card-toolbar">
					<div class="example-tools justify-content-center">
						<a href="dashboard.php?module=borrow&page=person-add" class="btn btn-success btn-sm font-weight-bold mr-2" title="บันทึกยืม-คืน"><i class="fa fa-plus-circle" title="บันทึกยืม-คืน" data-toggle="tooltip"></i>บันทึกยืม-คืน</a>
					</div>
				</div>
			</div>
    ...
    <div class="col-lg-2">
				...
				<input type="text" class="form-control"  name="servicedate" id="servicedate" placeholder="วันที่รับบริการ" value="<?php echo $service_date;?>"  data-date-language="th-th" maxlength="10" />
            ...
            <select class="form-control " name="service" id="service" >
                        <option value="" <?php if($service_type == ''){echo "selected";}?> >ทั้งหมด</option>
                        <option value="1" <?php if($service_type == '1'){echo "selected";}?> >ยืมอุปกรณ์</option>
                        <option value="2" <?php if($service_type == '2'){echo "selected";}?> >คืนอุปกรณ์</option>
            </select>
    ...
    $numb_data = $conn->query("SELECT count(1) FROM ".DB_PREFIX."service_main s  
                            ...
                            <!--begin::Dropdown-->
                                <div class="dropdown">
                                    ...
                                    <ul class="navi navi-hover py-1">
                                        ...
                                        <li class="navi-item">
                                            <a href="dashboard.php?module=borrow&page=person-add&personid=<?php echo $personid_enc;?>&servicedate=<?php echo $serviceid_enc;?>&servicetype=<?php echo base64_encode('2');?>&act=" class="navi-link">
                                                <span class="navi-icon"><i class="fas fa-file-import"></i></span>
                                                <span class="navi-text">คืนกายอุปกรณ์</span>
                                            </a>
                                        </li>
                                        <?php } ?>
                                        ...
                                        <li class="navi-item">
                                            <a href="#" class="navi-link" onclick='confirm_borrow_delete(<?php echo $service_id; ?>)'>
