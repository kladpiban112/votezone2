...
if($action == "view"){
    ...
    $sql_service = "SELECT s.*,t.service_title AS service_typename FROM ".DB_PREFIX."service_main s 
        ...
        <div class="row justify-content-center py-8 px-8 py-md-27 px-md-0">
            <div class="col-md-9">
                <div class="d-flex justify-content-between pb-10 pb-md-20 flex-column flex-md-row">
                    <h4 class=" mb-10">เอกสาร<?php echo $servicetype_show;?>กายอุปกรณ์</h4>
                ...
                <div class="d-flex justify-content-between pt-6">
                    <div class="d-flex flex-column flex-root">
                        <span class="font-weight-bolder mb-2">ผู้<?php echo $servicetype_show;?>กายอุปกรณ์</span>
